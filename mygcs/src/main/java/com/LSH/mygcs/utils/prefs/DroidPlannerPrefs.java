package com.LSH.mygcs.utils.prefs;
...
import com.LSH.mygcs.utils.Utils;
...
public class DroidPlannerPrefs {
    ...
    private static final String DEFAULT_TCP_SERVER_IP = "223.171.39.48";

    public static final String PREF_RTSP_URL = "pref_rtsp_url";
    private static final String DEFAULT_RTSP_URL = "rtsp://" + DEFAULT_TCP_SERVER_IP + "/8554/test";

    public static final String PREF_TCP_SERVER_PORT = "pref_server_port";
    private static final String DEFAULT_TCP_SERVER_PORT = "5760";
    ...
    private static com.LSH.mygcs.utils.prefs.DroidPlannerPrefs instance;

    public static synchronized com.LSH.mygcs.utils.prefs.DroidPlannerPrefs getInstance(Context context) {
        if (instance == null) {
            instance = new com.LSH.mygcs.utils.prefs.DroidPlannerPrefs(context);
        }
    ...
    public String getRtspUrl() {
        return prefs.getString(PREF_RTSP_URL, DEFAULT_RTSP_URL);
    }
